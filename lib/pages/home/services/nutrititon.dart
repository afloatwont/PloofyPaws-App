...
class _NutritionScreenState extends State<NutritionScreen> {
  final Map<String, IconData> properties = {
    "Balanced Diet": Icons.pets,
    "Weight management": Icons.breakfast_dining_rounded,
    "Small paws diet": Icons.restaurant_outlined,
    "Customised products": Icons.dashboard_customize_outlined,
  };
  ...
  final Map<String, Widget> whyPloofy = {
    "Balanced Diet": const Icon(Icons.pets),
    "Weight management": const Icon(Icons.breakfast_dining_rounded),
    "Small paws diet": const Icon(Icons.restaurant_outlined),
  };
              ...
              child: Column(
                children: [
                  TopBar(
                    ...
                    gradient: const Color(0xffef5b96e),
                    textColor: Color(0xffebc6a03),

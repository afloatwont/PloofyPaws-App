...
class EventSwiper extends StatefulWidget {
  ...
  ///
  /// This field is only considered when initializing an [EventSwiper].
  ...
  @override
  State createState() => _EventSwiperState();
}

class _EventSwiperState extends State<EventSwiper> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant EventSwiper oldWidget) {
...
/// A controller used to control an [EventSwiper],
///
...
class AppinioSwiperController extends ChangeNotifier {
  _EventSwiperState? _attachedSwiper;
  ...
  ///
  /// The default direction is set by the attached [EventSwiper] widget.
  ...
  void _attach(_EventSwiperState swiper) {
    assert(
...
class SwiperPosition with ChangeNotifier {
  ...
  /// [EventSwiper.maxAngle] when [progress] is 1.
  ///
  ...
  /// [EventSwiper.loop] is true, this will wrap to 0 at the end of the card
  ...
  void _updateFromWidgetState(EventSwiper widget) {

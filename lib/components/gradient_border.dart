...
class GradientBorder extends Border {
  ...
  void _paintGradientBorderWithRadius(Canvas canvas, Rect rect, BorderRadius borderRadius) {
  ...
  void _paintGradientBorderWithCircle(Canvas canvas, Rect rect) {
    ...
    paint
      ..strokeWidth = width
      ..style = PaintingStyle.stroke
      ..shader = borderGradient.createShader(Rect.fromCircle(center: rect.center, radius: radius));
